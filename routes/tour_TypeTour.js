...
tour_TypeTourRoute.put('/:id', authenticate.authenticateJWT, role.checkRole(["Admin"], { up: true }), tour_TypeTourCtrl.updateById);
tour_TypeTourRoute.delete('/:id', authenticate.authenticateJWT, role.checkRole(["Admin"], { del: true }), tour_TypeTourCtrl.deleteById);
